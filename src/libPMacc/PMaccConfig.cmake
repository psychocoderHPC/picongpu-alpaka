...
#-------------------------------------------------------------------------------
MARK_AS_ADVANCED(FORCE ALPAKA_ACC_CPU_B_SEQ_T_SEQ_ENABLE)
MARK_AS_ADVANCED(FORCE ALPAKA_ACC_CPU_B_SEQ_T_THREADS_ENABLE)
MARK_AS_ADVANCED(FORCE ALPAKA_ACC_CPU_B_SEQ_T_FIBERS_ENABLE)
MARK_AS_ADVANCED(FORCE ALPAKA_ACC_CPU_B_OMP2_T_SEQ_ENABLE)
MARK_AS_ADVANCED(FORCE ALPAKA_ACC_CPU_B_SEQ_T_OMP2_ENABLE)
MARK_AS_ADVANCED(FORCE ALPAKA_ACC_CPU_BT_OMP4_ENABLE)
MARK_AS_ADVANCED(FORCE ALPAKA_ACC_GPU_CUDA_ENABLE)

SET(PMACC_ACC_BACK_END "None" CACHE STRING "Accelerator back-end")
SET_PROPERTY(CACHE PMACC_ACC_BACK_END PROPERTY STRINGS "None;GPU Nvidia;CPU OMP2;CPU C++11 threads")
...
IF(${PMACC_ACC_BACK_END} STREQUAL "GPU Nvidia")
  SET(ALPAKA_ACC_GPU_CUDA_ENABLE ON CACHE BOOL " " FORCE)
ELSEIF(${PMACC_ACC_BACK_END} STREQUAL "CPU OMP2")
  SET(ALPAKA_ACC_CPU_B_SEQ_T_OMP2_ENABLE ON CACHE BOOL " " FORCE)
ELSEIF(${PMACC_ACC_BACK_END} STREQUAL "CPU C++11 threads")
